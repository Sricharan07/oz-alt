...
* `api_key` (str): Your API key (can be set via SMALLEST\_API\_KEY environment variable)
...
If you have any questions or suggestions, please create an issue on the [smallest-python-sdk GitHub ](https://github.com/smallest-inc/smallest-python-sdk).
