...
**Kind:** class
**Signature:** `class WebhookAgent(BaseModel):`
**Source:** https://raw.githubusercontent.com/smallest-inc/smallest-python-sdk/main/smallestai/atoms/models/webhook_agent.py#webhookagent
...
class WebhookAgent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "name", "description"]
