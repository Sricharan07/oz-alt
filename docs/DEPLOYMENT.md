...
OZ_AGENT_CARD_EMBEDDINGS=1
OZ_RECIPE_LLM_ENABLED=true
OZ_RECIPE_LLM_MODEL=gpt-4.1-mini
OZ_RECIPE_LLM_MAX_PER_VERSION=25
OZ_RECIPE_LLM_MAX_OUTPUT_TOKENS=900
OPENAI_API_KEY='...'
# Prefer this over a raw env key when using AWS Secrets Manager:
# OZ_OPENAI_API_KEY_SECRET_ARN='arn:aws:secretsmanager:...:secret:oz/openai-api-key-...'
OZ_LEGACY_CONTEXT_COMPOSITES=0
